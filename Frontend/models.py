...
class Blood(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="user_blood")
...
class Ambulance(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="user_ambulance")
    name = models.CharField(max_length=255)
...
class AmbulanceOrder(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="user_ambulance_order")
...
class DoctorAppointment(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="get_doctor_schedule")
